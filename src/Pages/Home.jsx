...
const scriptCode = `loadstring(game:HttpGet("https://raw.githubusercontent.com/Vizxls/StefanHub/refs/heads/main/Loader.lua"))()`;
    ...
    <div className="min-h-screen">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Code Block with Lua highlighting */}
          <LuaCodeBlock code={scriptCode} />
        </div>
      </motion.div>
